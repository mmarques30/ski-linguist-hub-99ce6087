...
export function getRegistrationPaymentSummary(
  ...
  if (option === REGISTRATION_PAYMENT_OPTIONS.STRIPE_FULL) {
    return {
      ...
      amountDueNowLabel: "Paiement intégral en ligne",
    };
  }
...
export const PAYMENT_OPTION_DESCRIPTIONS: Record<RegistrationPaymentOption, string> = {
  ...
  [REGISTRATION_PAYMENT_OPTIONS.VIREMENT]:
    "Effectuez un virement pour les frais de dossier. Le solde sera réglé par chèque, déposé après la fin du cours.",
