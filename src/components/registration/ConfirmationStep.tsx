          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              ...
              {result.documentsSent
                ? " Les documents d'inscription (critères de prise en charge 2026, convention Station 2022 et contenu pédagogique Station 2022) vous ont été envoyés par email."
                : result.emailSent
