...
| # | Item | Esforço | Status |
|---|---|---|---|
| D1 | Finance 6 → 3 páginas com abas (§9.8); glossário de KPIs; "Dépenses" real; objetivos de `seasons.revenue_target` (BL-039); corrigir dupla contagem da tesouraria | G | **feito** PR #67/#68 |
